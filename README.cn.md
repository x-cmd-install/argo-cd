...
[![x-cmd/install — argo-cd Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/argo-cd.svg?lang=zh)](https://x-cmd.com/install/argo-cd)
...
合计: **2,773,261** 行代码（覆盖前 5 种语言、共 **4042** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Html | 1,855,949 | 1,614 | 226,008 | 38 |
| Go | 454,944 | 30,900 | 42,849 | 1061 |
| Yaml | 368,573 | 2,048 | 3,391 | 2661 |
...
- **上游仓库**: <https://github.com/argoproj/argo-cd>
...
- **Star**: 24,227 · **Fork**: 7,874 · **开放 issue**: 10,676 · **贡献者**: 2,024

## 累计统计

- **发布数**: 582 · **已合并 PR**: 12568 · **开放 PR**: 833 · **已关闭 issue**: 7142 · **开放 issue**: 3534 · **提交数**: 11565

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-25 | 5 | 221 | 100 | 42 | 63 | 274 |
| last60d | 2026-07-26 | 12 | 454 | 175 | 76 | 140 | 472 |
| 90d | 2026-06-26 | 14 | 661 | 240 | 114 | 190 | 700 |
| last180d | 2026-03-28 | 35 | 1450 | 363 | 271 | 305 | 1382 |
| 360d | 2025-09-29 | 75 | 2592 | 517 | 598 | 544 | 2450 |
| last720d | 2024-10-04 | 100 | 4752 | 659 | 1366 | 1111 | 3944 |
...
argo-cd 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `argo-cd` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/argo-cd.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T05:09:27Z._
